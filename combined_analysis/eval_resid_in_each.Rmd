---
title: "Evaluate residuals in each cohort and brain region"
subtitle: ''
...
library(githubr)
parentId = 'syn22012942';
activityName = 'Evaluate residuals in each cohort and brain region';
activityDescription = 'Evaluate residuals in each cohort and brain region';
...
```{r}
CODE <- Folder(name = "Evaluate residuals in each cohort and brain region", parentId = "syn22012942")
CODE <- synStore(CODE)
...
```{r run.peer}
  ...
  latentVariables = PEER_getX(model)
