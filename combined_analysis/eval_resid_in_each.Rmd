...
```{r ancestry}
fig1 = ggplot(ANCESTRY.MPP, aes(EV.1, EV.2, color=Cluster)) + geom_point() + ggtitle("MPP ancestry")  + theme(aspect.ratio=1)
fig2 = ggplot(ANCESTRY.HBCC, aes(EV.1, EV.2, color=as.character(cluster))) + geom_point() + ggtitle("HBCC ancestry")  + theme(aspect.ratio=1)
fig3 = ggplot(ANCESTRY.HBCC, aes(EV.1, EV.2, color=Population)) + geom_point() + ggtitle("HBCC ancestry") + theme(aspect.ratio=1)
