...
df_module_enrich.Sex = enrich.test( df_module.Sex, go.gs, df_cohort2$Module[i])
```
...
df_module_enrich.Dx = enrich.test( df_module.Dx, go.gs, df_cohort2$Module[i])
```
...
df_module_enrich.Dx_Sex = enrich.test( df_module.Dx_Sex, go.gs, df_cohort2$Module[i])
```
