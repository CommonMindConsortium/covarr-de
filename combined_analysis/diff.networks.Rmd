...
```{r modules.in.discovery, fig.width=10, fig.height=20}
...
```{r second.cohort, fig.width=6, fig.height=12}
...
```{r modules.in.second.cohort, fig.width=8, fig.height=100}
...
```{r modules.in.discovery.Dx, fig.width=10, fig.height=20}
...
```{r modules.in.second.cohort.Dx, fig.width=15, fig.height=100}
  
i = which(df_cohort2$FDR < 0.05)[1:20]
