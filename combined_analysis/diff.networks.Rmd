...
```{r plot.meta.Sex}
ggplot(df_test_meta.Sex, aes(Module, -log10(P.Value))) + geom_bar(stat='identity', fill=df_test.Sex$Module) + theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "black")) + coord_flip() + facet_wrap(~Cohort) + ylab(bquote(-log[10]~P)) + scale_y_continuous(expand=c(0,0)) + geom_hline(yintercept = -log10(0.05), color="red", linetype="dashed") 

qqPlot(df_test_meta$P.Value)
```
...
```{r plot.meta.Dx_Sex}
ggplot(df_test_meta.Dx_Sex, aes(Module, -log10(P.Value))) + geom_bar(stat='identity', fill=df_test.Dx_Sex$Module) + theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "black")) + coord_flip() + facet_wrap(~Cohort) + ylab(bquote(-log[10]~P)) + scale_y_continuous(expand=c(0,0)) + geom_hline(yintercept = -log10(0.05), color="red", linetype="dashed") 

qqPlot(df_test_meta.Dx_Sex$P.Value)
```
