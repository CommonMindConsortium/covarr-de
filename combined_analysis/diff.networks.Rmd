...
```{r testing}
# Hypothesis testing         
df_test = test_differential_correlation(resid.add[[resVersion]], C.diff.discovery, dynamicColors, METADATA)#, BPPARAM=SnowParam(18)) 
```
...
figList = lapply(df_cohort2$Module[i], function(mod){
	...
	plot_module( mod, df_test.Dx_Sex, METADATA, dynamicColors.Dx_Sex, C.diff.discovery, resid.add[[resVersion]], variable, "NIMH-HBCC")   
	})
