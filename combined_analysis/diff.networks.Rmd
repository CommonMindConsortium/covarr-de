...
df_test = lapply( 1:10, function(k){
	...
	# Hypothesis testing         
	df_test = test_differential_correlation(resid.add[[resVersion]], C.diff.discovery, dynamicColors, METADATA, variable, useSLED=TRUE, .5, 20) 
...
# Hypothesis testing         
df_test_null = test_differential_correlation(resid.add[[resVersion]], C.diff.discovery, dynamicColors, METADATA, variable, useSLED=TRUE, .5, 20) 
```
...
```{r testing}
# Hypothesis testing         
df_test.Sex = test_differential_correlation(resid.add[[resVersion]], C.diff.discovery, dynamicColors.Sex, METADATA, variable, useSLED=TRUE, .5, 20)
```
