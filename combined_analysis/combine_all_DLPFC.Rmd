...
### Test marginals for Schizophrneia vs controls
...
pi1 = 1 - qvalue(df_meta_SCZ$P)$pi0
data.frame(pi1) %>% kable(caption="pi1 for SCZ meta-analysis") %>% kable_styling(full_width=FALSE)

```


# Test RCSD anbd ADAMTS2
