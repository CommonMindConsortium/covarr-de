...
vobj = voomWithDreamWeights(dge, form, info, plot=TRUE, save.plot=TRUE, BPPARAM=SnowParam(36, progressbar=TRUE))
```
...
vp = fitExtractVarPartModel( geneExpr, form, info, BPPARAM=SnowParam(36, progressbar=TRUE))
