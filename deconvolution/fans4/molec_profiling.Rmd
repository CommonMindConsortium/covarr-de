...
isexpr = rowSums(cpm(countsCombined)>1) >= 0.3*ncol(countsCombined)

dge = DGEList(countsCombined[isexpr,])
dge = calcNormFactors(dge)

geneExprCombined = cpm(dge, log=TRUE)
...
# full counts
file = '/hpc/users/hoffmg01/work/cmc_analysis/src/Roussos_MSSM_MolProf_FANS_4_geneCounts.csv.gz'
gz1 <- gzfile(file, "w")
...
# full counts
file = '/hpc/users/hoffmg01/work/cmc_analysis/src/Roussos_MSSM_MolProf_FANS_4_info.csv.gz'
gz1 <- gzfile(file, "w")
