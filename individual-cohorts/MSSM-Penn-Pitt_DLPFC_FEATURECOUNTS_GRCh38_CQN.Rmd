---
title: "MSSM-Penn-Pitt - DLPFC - DREAM - FEATURECOUNTS - GRCh38 - CQN - Model Selection"
...
knit2synapse::createAndKnitToFolderEntity(file = "individual-cohorts/MSSM-Penn-Pitt_DLPFC_FEATURECOUNTS_GRCh38_CQN.Rmd",
                                 parentId ="syn22012942",
                                 folderName = "MSSM-Penn-Pitt - DLPFC - DREAM - FEATURECOUNTS - GRCh38 - CQN")
```
...
thisFileName <- 'MSSM-Penn-Pitt_DLPFC_FEATURECOUNTS_GRCh38_CQN.Rmd'
...
METADATA = metadata %>%
  ...
  dplyr::filter(Tissue %in% c("DLPFC")) %>% 
...
# Code
CODE <- Folder(name = "MSSM-Penn-Pitt - DLPFC - DREAM - FEATURECOUNTS - GRCh38 - CQN", parentId = parentId)
CODE <- synStore(CODE)
...
COV_OBJ = synapser::File('CMC_DLPFC_Covariates.tsv', name = 'Covariates', parentId = CODE$properties$id)
