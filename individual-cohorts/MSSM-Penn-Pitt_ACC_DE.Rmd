...
thisFileName <- 'MSSM-Penn-Pitt_ACC_DE_Dx.Rmd'
...
```{r set-formula}
# remove RIN2 as RIN and RIN2 are highly correlated
adjust.covars <- c("Dx", "ageOfDeath", "EV.1", "PMI", "EV.4","EV.2","RIN", "EV.3", "EV.5", "IntronicRate")
...
RESIDUAL.GENE_EXPRESSION %>%
  ...
  write.table(file = 'CMC_ACC_netResidualExpression.tsv', sep = '\t', row.names=F, quote=F)
