---
title: "Differential Expression - MSSM-Penn-Pitt - DLPFC - Dx"
...
knit2synapse::createAndKnitToFolderEntity(file = "individual-cohorts/split_by_analysis/MSSM-Penn-Pitt_DLPFC_DE_Diagnosis.Rmd",
...
adjust.covars <- c("Dx", "ageOfDeath", "RIN2", "RIN", "IntronicRate", "IntragenicRate")
...
L = cbind(L1, L2, L3, data.frame(L4 = c(1, -0.5, -0.5, 0, 0, 0, 0)))
