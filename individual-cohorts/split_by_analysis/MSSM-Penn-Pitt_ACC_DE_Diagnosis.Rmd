...
adjust.covars <- glue::glue("scale({adjust.covars})")
"Dx" -> adjust.covars[1]
formula <- glue::glue("~ 0 + ", glue::glue_collapse(adjust.covars, sep = " + "), " + ", glue::glue_collapse(glue::glue("(1|{random_effect})"), sep = " + "))  
```
`r formula`

Note:removed RIN2 from formula as RIN and RIN2 are highly correlated.
...
saveRDS(sortCols(violin_plot), file = 'CMC_ACC_Dx_variancePartition.rds')
ADJ_OBJ = File('CMC_ACC_Dx_variancePartition.rds',
...
# Store voom object
saveRDS(VOOM.GENE_EXPRESSION, file = 'CMC_ACC_Dx_voom.rds')
ADJ_OBJ = File('CMC_ACC_Dx_voom.rds',
               name = 'voom object', 
               parentId = CODE$properties$id)
ADJ_OBJ = synStore(ADJ_OBJ, used = ALL_USED_IDs, activityName = activityName,
                   executed = thisFile, activityDescription = activityDescription)
...
# Store contrasts
saveRDS(L, file = 'CMC_ACC_Dx_contrasts.rds')
ADJ_OBJ = File('CMC_ACC_Dx_contrasts.rds',
...
# Store contrasts
saveRDS(formula, file = 'CMC_ACC_Dx_formula.rds')
ADJ_OBJ = File('CMC_ACC_Dx_formula.rds',
               name = 'formula', 
               parentId = CODE$properties$id)
ADJ_OBJ = synStore(ADJ_OBJ, used = ALL_USED_IDs, activityName = activityName,
                   executed = thisFile, activityDescription = activityDescription)
