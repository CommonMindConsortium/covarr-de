...
```{r knit2synapse, eval=TRUE}
library(synapser)
library(knit2synapse)
synLogin()
knit2synapse::createAndKnitToFolderEntity(file = "meta-analysis_sex.Rmd",
                                          parentId ="syn22281021",
...
```{r store, eval=TRUE}
# Code
CODE <- Folder(name = "Meta-analysis on sex", parentId = "syn22281021") # Make sure these match the folder name and parent Id in the first chunk.
CODE <- synStore(CODE)
