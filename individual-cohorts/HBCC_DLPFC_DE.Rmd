...
adjust.covars <- c("Dx_Sex", "ageOfDeath", "RIN", "IntronicRate", "IntragenicRate", "IntergenicRate")
random.effect <- c("Reported_Gender")
```
...
COVARIATES.tmp = data.matrix(COVARIATES[,c('Dx_Sex'), drop = FALSE])
...
WGCNA::plotDendroAndColors(tree, 
                           ...
                           groupLabels = colnames(COVARIATES.tmp[,c('Dx_Sex'), drop = FALSE]))
```
...
L = cbind(L1, L2, L3, 
          data.frame(L4 = c(1,0,-0.5, 0, -0.5, 0, 0, 0, 0, 0, 0)),
          data.frame(L5 = c(0, 1, 0, -0.5, 0, -0.5, 0, 0, 0, 0, 0)))
