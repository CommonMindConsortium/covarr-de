---
title: "Differential Expression - MSSM-Penn-Pitt - ACC DLPFC - Dx.Tissue"
...
knit2synapse::createAndKnitToFolderEntity(file = "MSSM-Penn-Pitt_DE_DxTissue.Rmd",
...
thisFileName <- 'MSSM-Penn-Pitt_DE_DxTissue.Rmd'
...
adjust.covars <- c("Dx.Tissue", "RIN2", "ageOfDeath", "EV.1", "PMI", "EV.4","EV.2","RIN", "EV.3", "EV.5", "IntronicRate")
random_effect <- c("Individual_ID", "Institution", "Reported_Gender")
```
...
adjust.covars <- c("Dx.Tissue", "ageOfDeath", "EV.1", "PMI", "EV.4","EV.2","RIN", "EV.3", "EV.5", "IntronicRate")
